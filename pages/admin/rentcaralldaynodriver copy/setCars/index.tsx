...
const ListRentCars = () => {
    ...
    const downloadexcel = (event:any) => {
        axios({
            url: 'https://d713apsi01-wa01kbtcom.azurewebsites.net/Export_Excel/CarPickup_and_drop_WithDriver/1',
            method: 'GET',
                    ...
                    <Box border="solid 1px #00A5A8" p={4} borderRadius={"10px"} justifySelf={"center"}>
                        ...
                        <Grid style={{ justifyContent: "center" }} >
                            ...
                            <Flex p={2} justifyContent={"center"} >
                                ...
                                <Button className='lable-rentcar' type='submit' colorScheme='teal' size='md' ml={5}><AiOutlineSearch onClick={downloadexcel} />Excel</Button>
                            </Flex>
                        </Grid>
                    </Box>
                </GridItem>
