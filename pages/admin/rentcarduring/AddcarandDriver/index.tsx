                ...
                <Grid h='200px'
                    ...
                    <GridItem colSpan={12}>
                        <FormControl>
                            ...
                            <Input placeholder='กรุณากรอกข้อมูล' value="บริษัท พี.ดี.อาร์.คาร์เซอร์วิส จำกัด" style={{ border: '1px #00AAAD solid' }} name='booking_date' value={form.brand} onChange={handlebrand} required />
                        </FormControl>
                    </GridItem>
                    <GridItem colSpan={12}>
                        <FormControl>
                            <FormLabel className='lable-rentcar'>ประเภทรถ</FormLabel>
                            <Select placeholder='เลือกประเภทรถ' style={{ border: '1px #00A5A8 solid'}} value={form.carname} onChange={handlecarname} required>
